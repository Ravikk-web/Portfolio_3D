...
const Hero = () => {
  return (
    <section className='relative w-full h-screen mx-auto custom-border-radius'>
      ...
      <div className='absolute top-[120px] sm:w-3/5 w-full flex flex-col justify-center items-start gap-2.5 px-14 py-9 sm:px-28 sm:py-14 h-[80v]'>
        ...
        <p className='text-base font-medium'> I love to challenge my limitations and creativity in order
