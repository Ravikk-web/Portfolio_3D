...
const Footer = () => {
  return (
    <>
        <footer
        className="flex flex-col items-center bg-black rounded text-center text-surface dark:bg-neutral-700 dark:text-white ">
        <div className="container px-6 pt-6 bg-zinc-300 custom-border-radius">
            <div className="mb-6 flex justify-center space-x-2">
            <a
                href="https://www.facebook.com/ravikant.kispotta"
                type="button"
            ...
            <a
                href="mailto:testravikkweb@gmail.com"
                type="button"
            ...
            <a
                href="https://www.instagram.com/ravi.k.kispotta/"
                type="button"
            ...
            <a
                href="https://in.linkedin.com/in/ravi-k-kispotta-18b121289"
                type="button"
            ...
            <a
                href="https://github.com/ravikk-web"
                type="button"
        ...
        <div className="w-full p-4 text-center ">
            © 2024 Copyright: 
            <a href="https://in.linkedin.com/in/ravi-k-kispotta-18b121289" target='_blank'> <b>Ravi K. K.</b></a>
        </div>
        </footer>
    </>
  )
